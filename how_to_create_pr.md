...
For example, CodeChefMust is the owner of this repository, so the GitHub URL for this is: https://github.com/CodeChefMUST/DSA

Once you fork this repository, a copy of this repository will be created on your GitHub account. You will be the owner of this newly created repository, so the GitHub URL for this will be: https://github.com/your-username/DSA
...
https://github.com/your-username/DSA.git
...
Be sure to use the actual name of the repository (i.e. DSA) to switch into that directory.
...
##### `Switched to branch '<name of the branch>' `
...
##### `git remote add upstream https://github.com/CodeChefMust/DSA.git`
